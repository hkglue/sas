...
1.  检查您的服务器上态势感知Agent的AliYunDun和AliYunDunUpdate进程是否正常运行。关于态势感知Agent进程说明，请参考[Agent说明](cn.zh-CN/用户指南/接入态势感知/Agent说明.md#)。
...
如果态势感知Agent安装验证失败，请参考[Agent离线排查](cn.zh-CN/用户指南/接入态势感知/Agent离线排查.md#)。
